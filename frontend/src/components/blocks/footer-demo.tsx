...
export function FooterDemo() {
  return (
    <Footer
      className="mt-20 bg-white border-t border-slate-100"
      brand={{
        name: "CareRemind",
        description: "Automate your clinic's patient reminders and reduce no-shows effortlessly.",
        logo: (
